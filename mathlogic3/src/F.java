...
{	
	...
	public abstract Proof getProof(HashMap<String, Boolean> vars) throws Exception;
	
	public abstract boolean getVerity(HashMap<String, Boolean> vars) throws Exception;
